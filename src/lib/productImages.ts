const productImageOverrides: Record<string, string> = {
  ...
  'health mutation cap potion': '/images/store/single-mutation-cap.webp',
  'melee mutation cap potion': '/images/store/single-mutation-cap.webp',
  'stamina mutation cap potion': '/images/store/single-mutation-cap.webp',
