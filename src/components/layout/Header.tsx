      ...
      <div className="relative">
        ...
        <nav className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            >
              <img
                src="/hardreset-favicon.png"
                alt="HardReset"
                className="w-10 h-10 rounded-lg object-cover shadow-lg group-hover:shadow-ark-500/20 transition-all duration-300 group-hover:scale-105"
              />
                      ...
                      <div className="p-2">
                        ...
                        >
                          ...
                          <div>
                            ...
                            <span className="block text-xs text-volcanic-500">
                              {t(
                                'header.view_full_catalog'
                              )}
                            </span>
                          </div>
                        </Link>
                            ...
                            return (
                              ...
                              >
                                ...
                                <div className="flex-1 min-w-0">
                                  ...
                                  {cat.description && (
                                    <span className="block text-xs text-volcanic-500 truncate">
                                      {stripHtml(
                                        cat.description
                                      )}
                                    </span>
                  ...
                  {userOpen && (
                    <div className="absolute top-full right-0 mt-2 w-60 bg-volcanic-900/95 backdrop-blur-2xl border border-volcanic-800/60 rounded-xl shadow-2xl shadow-black/40 overflow-hidden animate-fade-in-down p-1.5 z-50">
                      <div className="px-3 py-2.5 border-b border-volcanic-800/60 mb-1">
                        ...
                        {authUser.email && (
                          <p className="text-xs text-volcanic-500 truncate">
                            {authUser.email}
                          </p>
                        )}
                      </div>
